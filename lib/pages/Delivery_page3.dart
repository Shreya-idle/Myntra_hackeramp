...
//   //   });
//   // }
//   Future<List<Map<String, dynamic>>> fetchCities(String apiKey) async {
//     final response = await http.get(Uri.parse('https://maps.googleapis.com/maps/api/place/textsearch/json?query=cities&key=$apiKey'));
//
...
//
//
//   Future<void> storeCitiesInFirebase(List<Map<String, dynamic>> cities) async {
